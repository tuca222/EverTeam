...
namespace Everteam
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IVacationOpportunityRepository, VacationOpportunityRepository>();
            services.AddScoped<IVacationOpportunityService, VacationOpportunityService>();

            services.AddScoped<ICareerRepository, CareerRepository>();

            services.AddScoped<IServiceRepository, ServiceRepository>();

            services.AddScoped<IProfessionalLevelRepository, ProfessionalLevelRepository>();
